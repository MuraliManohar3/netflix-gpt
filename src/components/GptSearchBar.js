...
const GptSearchBar = () => {
    ...
    const searchMovieTMDB = async (movie) => {
        ...
        const data = await fetch(
            "https://api.themoviedb.org/3/search/movie?query=" + movie + "%22&include_adult=false&page=1&sort_by=popularity.desc",
            API_OPTIONS
        );
    ...
    const handleGptSearchClick = async () => {
        ...
        // [Arjun Reddy, Geetha Govindam, Rangasthalam, Kshanam, Bommarillu]
